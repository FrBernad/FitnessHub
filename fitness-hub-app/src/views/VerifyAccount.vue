  ...
  <v-container fluid fill-height>
    ...
    <v-row align="center" justify="center">
      <v-col cols="10" sm="10" md="7" lg="6">
        <v-card light color="rgb(233 236 239)" class="pa-4">
          <v-container fluid>
            <v-row align="center" justify="center">
              <v-col cols="12">
              ...
              <v-col cols="6" class="d-flex align-center justify-center pt-0">
                <v-btn color="primary" large width="50%" @click="verifyUser">VERIFY</v-btn>
              </v-col>
              <v-col cols="12" class="pb-0">
                ...
                <v-row justify="center">
                  ...
                  <v-col cols="4" class="d-flex align-center justify-center pa-0 pb-7">
                    <v-btn color="primary" width="50%" @click="resendVerification">RESEND</v-btn>
                  </v-col>
                </v-row>
              </v-col>
            </v-row>
